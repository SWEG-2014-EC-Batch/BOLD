// A C++ program that defines two strings and performs various operations on them using a user-defined function.
#include <iostream>
...
int main() {
    ...
    cout << "Lowercase version of string 1: " << lower1 << endl;
    cout << "Lowercase version of string 2: " << lower2 << endl;

    cout << "Uppercase version of string 1: " << upper1 << endl;
    cout << "Uppercase version of string 2: " << upper2 << endl;
