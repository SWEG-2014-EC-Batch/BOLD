...
using namespace std;
int main() {
    double gross_salary, worked_hours, overtime_rate, overtime_bonus, gift, pension, income_tax, net_salary;
    ...
    // calculate overtime bonus,if it is there
    if (worked_hours > 40) {
...
if (gross_salary>=0 && gross_salary<=200) {income_tax= 0;}
    ...
    net_salary = gross_salary - pension - (gross_salary * income_tax) + overtime_bonus+ gift;
